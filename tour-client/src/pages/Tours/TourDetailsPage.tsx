  ...
  return (
      ...
      <header className={styles.tourHeader}>
        ...
        <p className={styles.tourSubtitle}>
          Whether you’re travelling solo, as a couple, with family, or a group
          of friends, these curated routes give you a starting point to discover
          Sri Lanka. Click into a tour type to see more details and a focused
          map of that route.
        </p>
      </header>
      ...
      <section>
        ...
        <h2>Romantic Coastal Escape</h2>
          ...
          <Link to="/tours/family" className={`${styles.tourCard} ${styles.family}`}>
          <h2 className={styles.tourCardTitle}>Family Discovery Trail</h2>
          <p className={styles.tourTag}>Family • 5 days • Kid friendly</p>
          <p className={styles.tourDesc}>
            Wildlife, easy hikes, and cultural highlights designed so parents
            can enjoy the trip without stress.
          </p>
        </Link>

     <Link to="/tours/group" className={`${styles.tourCard} ${styles.group}`}>
          <h2 className={styles.tourCardTitle}>Friends & Group Adventure</h2>
      ...
      <Link to="/tours/solo" className={`${styles.tourCard} ${styles.solo}`}>
          <h2 className={styles.tourCardTitle}>Solo Explorer Route</h2>
          <p className={styles.tourTag}>Solo • 5 days • Flexible</p>
          <p className={styles.tourDesc}>
            Safe and flexible path that connects social hostels, scenic train
            rides, and coastal town stops.
          </p>
        </Link>
      </section>
